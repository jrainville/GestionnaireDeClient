...
<div class="container">
    ...
    <div class="content">
        ...
        <form action="#" method="post" class="creerClient">
            <?php
                $affichage='<div class="field text"><label for="nomClient">Client<span class="requiredField">*</span></label>
                ...
                $affichage.='<div class="field text"><label for="adresse">Adresse<span class="requiredField">*</span></label>
                ...
                $affichage.='<div class="field text"><label for="ville">Ville<span class="requiredField">*</span></label>
                ...
                $affichage.='<div class="field text"><label for="telephone">Téléphone<span class="requiredField">*</span></label>
                ...
                $affichage.='<div class="field date"><label for="dateNaissance">Né(e) le<span class="requiredField">*</span></label>
                ...
                $affichage.='<div class="field text"><label for="codePostal">Code Postal<span class="requiredField">*</span></label>
                ...
                $affichage.='<div class="field select"><label>Sexe<span class="requiredField">*</span></label>
                <select name="sexe">
